    ...
    return (
      <div className='docs-container'>
          ...
          <div className='docs-box-01'>
             ...
             <div className='docs-01-text'><div>Create Decentralized Oracle Dapp that will evaluate your results (<a href='https://github.com/DecentralizedAITracker/aitracker-sdk' target="_blank"> link </a>).</div> </div>
          </div>
          <div className='docs-box-01'>
             <div className='docs-01-number'>3</div>
             <div className='docs-01-text'><div>Implement aitracker-sdk in your Machine Learning Dapp and Decentalized Oracle Dapp so they can communicate privately. </div> </div>
          </div>
          <div className='docs-box-01'>
